...
//    [self.mainVCView insertSubview:self.leftOpenView atIndex:self.mainVCView.subviews.count-2];
//    [self.mainVCView insertSubview:self.maskView atIndex:self.mainVCView.subviews.count-1 ];
//    [self.mainVCView addSubview:self.maskView];
//    [self.mainVCView addSubview:self.leftOpenView];
